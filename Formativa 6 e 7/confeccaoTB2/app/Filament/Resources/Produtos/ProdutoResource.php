...
class ProdutoResource extends Resource
{
    ...
    public static function form(Schema $schema): Schema
    {
        ...
        return $schema
        ->schema([
            TextInput::make('nome')->required()->label("Nome Produto"),
            TextInput::make('referencia')->required()->label('Referencia'),
            TextInput::make('preco_venda')->numeric()->prefix("R$")->label('Preco Venda'),
