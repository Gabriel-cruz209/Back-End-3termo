        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 bg-gray-50 border-b border-gray-200">
                    <div class="flex justify-between items-center">
                        <div>
                            <h3 class="text-lg font-medium text-gray-900">Fornecedores Cadastrados</h3>
                            <p class="mt-1 text-sm text-gray-600">{{ $fornecedores->count() }} fornecedores cadastrados</p>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 font-mono">{{ $fornecedor->cnpj }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $fornecedor->email }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $fornecedor->telefone }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $fornecedor->cep ?: 'Não informado' }}</td>
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-4 text-center text-gray-500">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <a href="{{ route('fornecedores.create') }}" class="mt-2 text-indigo-600 hover:text-indigo-500">Cadastrar primeiro fornecedor</a>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
