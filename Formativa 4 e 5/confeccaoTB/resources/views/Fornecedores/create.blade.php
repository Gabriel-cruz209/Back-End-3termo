        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-6 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form action="{{ route('fornecedores.store') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        <label class="block font-medium text-sm text-gray-700">endereco</label>
                        <textarea name="endereco" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1 block w-full" rows="2">{{ old('cep') }}</textarea>
                    </div>
